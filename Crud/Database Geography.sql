...
(N'AX', N'ALA', N'Aland', N'EUR', N'EU', 26711, 1580, N'Mariehamn'),
...
(N'BL', N'BLM', N'Saint Barthelemy', N'EUR', N'NA', 8450, 21, N'Gustavia'),
...
(N'BR', N'BRA', N'Brazil', N'BRL', N'SA', 201103330, 8511965, N'Brasilia'),
...
(N'CM', N'CMR', N'Cameroon', N'XAF', N'AF', 19294149, 475440, N'Yaounde'),
(N'CN', N'CHN', N'China', N'CNY', N'AS', 1330044000, 9596960, N'Beijing'),
(N'CO', N'COL', N'Colombia', N'COP', N'SA', 47790000, 1138910, N'Bogota'),
(N'CR', N'CRI', N'Costa Rica', N'CRC', N'NA', 4516220, 51100, N'San Jose'),
...
(N'EH', N'ESH', N'Western Sahara', N'MAD', N'AF', 273008, 266000, N'El Aaiun'),
...
(N'FO', N'FRO', N'Faroe Islands', N'DKK', N'EU', 48228, 1399, N'Torshavn'),
...
(N'GU', N'GUM', N'Guam', N'USD', N'OC', 159358, 549, N'Hagatna'),
...
(N'MV', N'MDV', N'Maldives', N'MVR', N'AS', 395650, 300, N'Male'),
...
(N'PY', N'PRY', N'Paraguay', N'PYG', N'SA', 6375830, 406750, N'Asuncion'),
...
(N'ST', N'STP', N'Sao Tome and Principe', N'STD', N'AF', 175808, 1001, N'Sao Tome'),
...
(N'TF', N'ATF', N'French Southern Territories', N'EUR', N'AN', 140, 7829, N'Port-aux-Francais'),
(N'TG', N'TGO', N'Togo', N'XOF', N'AF', 6587239, 56785, N'Lome'),
...
(N'STD', N'Sao Tome and Principe Dobra'),
...
(N'WST', N'Samoa Tala'),
(N'XAF', N'Communaute Financiere Africaine (BEAC) CFA Franc BEAC'),
(N'XCD', N'East Caribbean Dollar'),
(N'XDR', N'International Monetary Fund (IMF) Special Drawing Rights'),
(N'XOF', N'Communaute Financiere Africaine (BCEAO) Franc'),
(N'XPF', N'Comptoirs Francais du Pacifique (CFP) Franc'),
(N'YER', N'Yemen Rial'),
...
(8, N'Parana', 4880, 2582672, 18000, N'Rio de la Plata'),
...
(20, N'Purus', 3211, 63166, 8400, N'Amazon'),
(21, N'Yukon', 3185, 850000, 6210, N'Bering Sea'),
(22, N'Indus', 3180, 960000, 7160, N'Arabian Sea'),
(23, N'Sao Francisco', 3180, 610000, 3300, N'Atlantic Ocean'),
